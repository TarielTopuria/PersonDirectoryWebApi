...
namespace PersonDirectoryWebApi.Controllers
{
    ...
    public class RelatedPersonsController : ControllerBase
    {
        ...
        public async Task<ActionResult<RelativePersonsDto>> GetRelatedPerson(int personId, int relatedPersonId)
        {
            ...
            {
                _logger.LogError($"Problem occured while trying to use GET Method to get info about Relationships using personId and relatedPersonId. See the message: {e.Message}");
                throw;
            }
        }
        ...
        public async Task<ActionResult<RelativePersonsDto>> CreateRelatedPerson(int personId, CreateRelatedPersonDto relatedPerson)
        {
            ...
            {
                _logger.LogError($"Problem occured while trying to use Post Method to create Related Person with Person with Id {personId}. See the message: {e.Message}");
                throw;
            }
        }
